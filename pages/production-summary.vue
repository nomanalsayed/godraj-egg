    ...
    <div class="bg-white p-6 rounded-lg shadow mb-6">
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-2xl font-bold">
          Production Summary for Existing KBF
        </h2>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th colspan="5" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                No of HE in Lac
              </th>
            ...
            <tr>
              <th v-for="year in years" :key="`he-${year}`" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                {{ year }}
              </th>
              <th v-for="year in years" :key="`doc-${year}`" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                {{ year }}
              </th>
            </tr>
          </thead>
...
const { data: apiData } = await useFetch<{ data: ProductionSummary[] }>('/api/production-summary')
