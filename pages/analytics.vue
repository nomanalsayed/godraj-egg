  ...
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <div class="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-lg shadow-lg">
        <h3 class="text-sm font-semibold opacity-90 mb-2">Total Birds</h3>
        <p class="text-3xl font-bold">{{ analytics.totalBirds.toLocaleString() }}</p>
        <p class="text-xs opacity-75 mt-1">All age groups</p>
      </div>

      <div class="bg-gradient-to-br from-green-500 to-green-600 text-white p-6 rounded-lg shadow-lg">
        <h3 class="text-sm font-semibold opacity-90 mb-2">Laying Birds</h3>
        <p class="text-3xl font-bold">{{ analytics.layingBirds.toLocaleString() }}</p>
        <p class="text-xs opacity-75 mt-1">Age 24-65 weeks</p>
      </div>

      <div class="bg-gradient-to-br from-purple-500 to-purple-600 text-white p-6 rounded-lg shadow-lg">
        <h3 class="text-sm font-semibold opacity-90 mb-2">Peak Production</h3>
        <p class="text-3xl font-bold">{{ analytics.peakBirds.toLocaleString() }}</p>
        <p class="text-xs opacity-75 mt-1">Age 30-45 weeks</p>
      </div>

      <div class="bg-gradient-to-br from-orange-500 to-orange-600 text-white p-6 rounded-lg shadow-lg">
        <h3 class="text-sm font-semibold opacity-90 mb-2">Avg Age</h3>
        <p class="text-3xl font-bold">{{ analytics.avgAge.toFixed(1) }}</p>
        <p class="text-xs opacity-75 mt-1">weeks</p>
      </div>
    </div>

    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
      <div class="bg-white p-6 rounded-lg shadow">
        <h2 class="text-xl font-bold mb-4">Age Distribution</h2>
        <div class="space-y-3">
          <div v-for="dist in ageDistribution" :key="dist.category" class="flex items-center">
            <div class="w-32 text-sm font-medium text-gray-700">{{ dist.category }}</div>
      ...
      <div class="bg-white p-6 rounded-lg shadow">
        <h2 class="text-xl font-bold mb-4">Stock Type Breakdown</h2>
        <div class="space-y-3">
          <div v-for="type in stockTypes" :key="type.type" class="flex items-center">
            <div class="w-32 text-sm font-medium text-gray-700">{{ type.type }}</div>
            <div class="flex-1 bg-gray-200 rounded-full h-6 relative overflow-hidden">
              <div 
    ...
    <div class="bg-white p-6 rounded-lg shadow mb-6">
      <h2 class="text-xl font-bold mb-4">Weekly Stock Summary</h2>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Laying Birds</th>
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Avg Age</th>
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Est. Production</th>
            </tr>
          </thead>
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="week in weeklySummary.slice(0, 10)" :key="week.week_date">
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ week.week_date }}</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ week.total_birds.toLocaleString() }}</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ week.laying_birds.toLocaleString() }}</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ week.avg_age.toFixed(1) }}</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-green-600">{{ week.est_production.toLocaleString() }}</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="border-l-4 border-blue-500 pl-4 py-2">
          <h3 class="font-semibold text-gray-800">Production Capacity</h3>
        ...
        <div class="border-l-4 border-green-500 pl-4 py-2">
          <h3 class="font-semibold text-gray-800">Peak Performance</h3>
          <p class="text-sm text-gray-600 mt-1">
        ...
        <div class="border-l-4 border-purple-500 pl-4 py-2">
          <h3 class="font-semibold text-gray-800">Flock Health</h3>
          <p class="text-sm text-gray-600 mt-1">
        ...
        <div class="border-l-4 border-orange-500 pl-4 py-2">
          <h3 class="font-semibold text-gray-800">Replacement Planning</h3>
          <p class="text-sm text-gray-600 mt-1">
